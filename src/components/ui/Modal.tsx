...
const Modal: React.FC<ModalProps> = ({
  ...
  const getContainerClasses = () => {
    switch (position) {
      ...
      default: // center
        return "relative flex items-center justify-center min-h-screen p-4 z-10";
    }
  };
          ...
          >
            ...
            >
              ...
              {(title || showCloseButton) && (
                <div
                  className={`flex items-center justify-between border-b border-primary-200 px-6 py-4 ${headerClassName}`}
                >
                  <div className="flex items-center space-x-3">
                    {icon && (
                      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-primary-50 to-accent-50">
                        {icon}
                      </div>
                    )}
                    {title && (
                  ...
                  {showCloseButton && (
                    <button
                      ...
                      className="rounded-lg p-2 text-slate-400 transition-colors hover:bg-primary-50 hover:text-primary-600 disabled:cursor-not-allowed disabled:opacity-50"
              ...
              {footer && (
                <div
                  className={`border-t border-primary-200 px-6 py-4 ${footerClassName}`}
                >
                  {footer}
                </div>
              )}
